...
```sh
# One shot
nix run github:Vincevdb1/nvim#default
nix run github:Vincevdb1/nvim#vanilla

# Development
nix run /path/to/your/local/nvim#default
nix run /path/to/your/local/nvim#vanilla
```
...
```sh
# Remote install
nix profile add github:Vincevdb1/nvim#default
# or
nix profile add github:Vincevdb1/nvim#vanilla

# Using a local clone of this repository
nix profile add /path/to/nvim/#default
# or
nix profile add /path/to/nvim/#vanilla
```
...
```nix
{
  inputs = {
    ...
    neovim-flake.url = "github:Vincevdb1/nvim";
    # ...
  };
